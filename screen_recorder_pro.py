...
class RecordingThread(QThread):
    ...
    def __init__(self, output_path, fps, codec, region=None, record_audio=False, audio_path=None):
        super().__init__()
        self.output_path = output_path
        self.fps = fps
        self.codec = codec
...
class ScreenRecorderPro(QMainWindow):
    """Main application window - Pro version with audio"""
    ...
    def init_ui(self):
        ...
        # Title
        title_label = QLabel("PyRecorder Pro - Screen Recorder with Audio")
    ...
    def start_recording(self):
        ...
        """)
        self.status_label.setText("Recording..." + (" (with audio)" if record_audio else ""))
        self.progress_bar.setMaximum(0)
        self.progress_bar.setMinimum(0)
